...
function ChatViewContent(props: ChatViewProps) {
  ...
  const onProviderModelSelect = useCallback(
    (instanceId: ProviderInstanceId, model: string) => {
      ...
      // One harness, one provider: any model in the catalog is switchable
      // mid-thread — the router just serves the next turn with it.
  ...
  const rightPanelContent = activeThreadRef ? (
    activeRightPanelSurface?.kind === "preview" ? (
      ...
      <PullRequestsUnavailableState
        ...
        error="Update this environment's server to browse pull requests."
      />
                ...
                <div className="pointer-events-auto relative z-10">
                  {isDraftHeroState ? (
                    <div className="absolute inset-x-0 bottom-full z-0">
                      ...
                      >
                        <DraftHeroHeadline activeProjectTitle={activeProject?.title ?? null} />
                      </div>
